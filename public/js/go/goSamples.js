// Highlight.js:
if (window.require) {
  require(["js/go/highlight.js"], function() {
    //This function is called after some/script.js has loaded.
  });
} else {
  document.write('<script src="js/go/highlight.js"></script>');
}

var link = document.createElement("link");
link.type = "text/css";
link.rel = "stylesheet";
link.href = "css/go/highlight.css";
...
function goSamples() {
  ...
  for (var i = 0; i < l; i++) {
    ...
    img.src = "images/go/images/screenshots/" + imgname + ".png";
